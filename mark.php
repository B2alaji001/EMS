...
$sql = "SELECT pid, project.eid, pname, duedate, subdate, mark, points, firstName, lastName, base, bonus, total FROM `project` , `rank` ,`employee`, `salary`  WHERE pid = $pid AND project.eid = $id";
...
<html>
<head>
  <title>Project Mark | OGI Technologies</title>
  <!-- Icons font CSS-->
